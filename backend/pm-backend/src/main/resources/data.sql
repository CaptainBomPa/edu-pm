...
VALUES
    ('Improved search result filtering', 'Enhancing the filtering options for search results to provide a better user experience.', 1, 4, 1, 1, 1),
    ('Advanced search result sorting', 'Implementing advanced sorting algorithms for search results to boost performance.', 1, 4, 2, 1, 1),
    ('User-friendly homepage redesign', 'Redesigning the homepage with a user-centric approach to improve engagement.', 2, 4, 3, 1, 1),
    ('Profile page makeover', 'Giving the profile page a fresh new look to increase user satisfaction.', 2, 4, 5, 1, 1),
    ('Optimized server-side caching', 'Implementing server-side caching techniques to speed up data retrieval.', 3, 4, 8, 1, 1),
    ('Enhanced database indexing', 'Improving database indexing for faster query processing and scalability.', 3, 4, 13, 1, 1),
    ('Streamlined registration process', 'Simplifying the user registration process for a smoother onboarding experience.', 1, 4, 1, 1, 1),
    ('Personalized user recommendations', 'Implementing recommendation algorithms for personalized user content suggestions.', 1, 4, 2, 1, 1),
    ('Efficient data synchronization', 'Enhancing data synchronization processes to ensure data consistency across devices.', 2, 4, 3, 1, 1),
    ('Mobile-friendly interface', 'Adapting the interface for mobile devices to cater to a broader user base.', 2, 4, 5, 1, 1),
    ('Improved notification system', 'Enhancing the notification system to keep users informed and engaged.', 3, 4, 8, 1, 1),
    ('Security enhancements', 'Implementing advanced security measures to protect user data and privacy.', 3, 4, 13, 1, 1),
    ('User feedback integration', 'Integrating a user feedback system to gather valuable insights and suggestions.', 1, 4, 1, 1, 1),
    ('Content sharing options', 'Adding options for users to easily share content with their social networks.', 1, 4, 2, 1, 1),
    ('Social media login', 'Allowing users to log in using their social media accounts for added convenience.', 2, 4, 3, 1, 1),
    ('Gamification elements', 'Introducing gamification elements to increase user engagement and interaction.', 2, 4, 5, 1, 1),
    ('Enhanced image uploading', 'Improving image uploading functionality for a smoother user experience.', 3, 4, 8, 1, 1),
    ('Integrated user chat', 'Implementing a real-time chat feature for users to connect and communicate.', 3, 4, 13, 1, 1),
    ('Content recommendation engine', 'Developing a recommendation engine to suggest content based on user preferences.', 1, 4, 1, 1, 1),
    ('Accessibility improvements', 'Enhancing the platforms accessibility features to cater to all users.', 1, 4, 2, 1, 1),
    ('Localized content support', 'Adding support for multiple languages and localized content.', 2, 4, 3, 1, 1),
    ('Interactive user tutorials', 'Creating interactive tutorials to help users make the most of the platform.', 2, 4, 5, 1, 1),
    ('Enhanced video streaming', 'Improving video streaming quality and performance for better user experience.', 3, 4, 8, 1, 1),
    ('Advanced content analytics', 'Implementing analytics to track user engagement and content performance.', 3, 4, 13, 1, 1),
    ('User profile customization', 'Allowing users to customize their profiles with personal information and themes.', 1, 4, 1, 1, 1);
