...
VALUES ('admin', '$2a$10$R2rNkxslm96X9a/hOUx05..X8EmTJ89tjlyylGvBlAbN0qAQNKiAS', 1, '{ADMINISTRATOR}', 'Jan',
        'Kowalski',
        1, true),
       ('user', '$2a$10$.bdr4pJ94f3sAUTBzy2G9eADtbMPyohOzo397uXUhKJ6EQZ93fqAK', 1, '{USER_WRITE}', 'Adam', 'Nowak', 1,
        true),
       ('user1', '$2a$10$rCCbi2RNkNPycu8WIJyKCeidli6kvZEnU7XQHsUtiyz/Li7f0yp2e', 1, '{USER_WRITE}', 'Krzysztof',
        'Nowak',
        1, true),
       ('user2', '$2a$10$QqOTJhnIGGSg/mqoxkScxutbWudW4hFTWLK0tEhHAKWGET5wHplaS', 1, '{USER_WRITE}', 'John', 'Smith', 1,
        true),
       ('user3', '$2a$10$AULhsFKeUaSmGH2RVzgmWOp.LVqN.GCK4Tr8QeqIGxRHwP7/m0AfC', 2, '{USER_WRITE}', 'Michael',
        'Anderson',
        1, true),
       ...
       ('user5', '$2a$10$QrjBFWm9SjwpBFFCbb.n.ujAIij8392v7Gtazf1R6YnRyI2N.Rmwy', 2, '{USER_WRITE}', 'Sophia', 'Brown',
        1,
        true),
       ('user6', '$2a$10$.yg0sg/fPvEHTV3jqYF4VuhWY5H34IIPy.y/iWZWsWazKkemibGkq', 2, '{USER_WRITE}', 'Jennifer',
        'Miller',
        1, true),
