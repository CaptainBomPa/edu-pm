...
VALUES ('2023-12-09T00:00:01', '2023-12-23T00:00:00'),
...
VALUES ('admin', '$2a$10$R2rNkxslm96X9a/hOUx05..X8EmTJ89tjlyylGvBlAbN0qAQNKiAS', 1,
        '{ADMINISTRATOR, PROJECT_SUPERVISOR, EDITING}', 'Jan',
        'Kowalski',
        1, true),
       ('user', '$2a$10$.bdr4pJ94f3sAUTBzy2G9eADtbMPyohOzo397uXUhKJ6EQZ93fqAK', 1, '{EDITING}', 'Adam', 'Nowak', 1,
        true),
       ('user1', '$2a$10$rCCbi2RNkNPycu8WIJyKCeidli6kvZEnU7XQHsUtiyz/Li7f0yp2e', 1, '{}', 'Krzysztof',
        'Nowak',
        1, true),
       ('user2', '$2a$10$QqOTJhnIGGSg/mqoxkScxutbWudW4hFTWLK0tEhHAKWGET5wHplaS', 1, '{EDITING}', 'John', 'Smith', 1,
        true),
       ('user3', '$2a$10$AULhsFKeUaSmGH2RVzgmWOp.LVqN.GCK4Tr8QeqIGxRHwP7/m0AfC', 2, '{EDITING}', 'Michael',
        'Anderson',
        1, true),
       ('user4', '$2a$10$Yx70ZocViQHQ/3GeBkyoae3zDCdGnig7uxRR6vaXuouc7LpLzWw.6', 2, '{EDITING}', 'Christopher',
        'Martinez', 1, true),
       ('user5', '$2a$10$QrjBFWm9SjwpBFFCbb.n.ujAIij8392v7Gtazf1R6YnRyI2N.Rmwy', 2, '{EDITING}', 'Sophia', 'Brown',
        1,
        true),
       ('user6', '$2a$10$.yg0sg/fPvEHTV3jqYF4VuhWY5H34IIPy.y/iWZWsWazKkemibGkq', 2, '{EDITING}', 'Jennifer',
        'Miller',
        1, true),
       ('user7', '$2a$10$Znw2pC9ZSYy1NYiXUaYnleyLe8y6q2wvovG/J4SsZRSpiCNqtKsre', 3, '{EDITING}', 'Benjamin', 'Hall',
        1, true),
       ('user8', '$2a$10$6mw/SkwJwUBR/fAYL09gq.VwLqy9TotXOoO7DqCuwy0uGIao01vbi', 3, '{EDITING}', 'Emma', 'Clark', 1,
        true),
       ('user9', '$2a$10$/ZONodOoDdOCxllx7diEnOspRuffJpjUCyIpGBi1KuosIHViCzsjO', 3, '{EDITING}', 'Joshua', 'Walker',
        1, true),
       ('user10', '$2a$10$gSJ2MxbT93qOk4KxpSTEPe9gZ3swguhoE5ltA608KWoLiw3OD8oOW', 3, '{EDITING}', 'Jacob', 'Turner',
        1, true),
       ('user11', '$2a$10$gSJ2MxbT93qOk4KxpSTEPe9gZ3swguhoE5ltA608KWoLiw3OD8oOW', null, '{}', 'Jan', 'Kowalski',
        null, false),
       ('user12', '$2a$10$gSJ2MxbT93qOk4KxpSTEPe9gZ3swguhoE5ltA608KWoLiw3OD8oOW', null, '{}', 'Mariusz', 'Kowalczyk',
        null, false),
       ('user13', '$2a$10$gSJ2MxbT93qOk4KxpSTEPe9gZ3swguhoE5ltA608KWoLiw3OD8oOW', null, '{}', 'John', 'Johnson',
        null, false);
